#!/usr/bin/env python3
"""V102: balanced volume gate on top of V101 MTF/DNA combo contract.
...
OUT_DIR = ROOT / 'smc_opt_v102_balanced_volume_gate'
...
ENGINE = 'V102_BALANCED_VOLUME_GATE'
FEE_PCT = 0.12
NET_SUCCESS_PCT = 0.8
...
def enrich_row(row: Dict[str, Any], dna: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
    ...
    x['production_eligible_v102'] = bool(x['production_eligible_v101'] or balanced_volume_gate)
...
def field_missing(rows: List[Dict[str, Any]]) -> Dict[str, int]:
    keys = [
        ...
        'production_whitelist_v101', 'production_eligible_v101', 'v102_balanced_volume_gate', 'production_eligible_v102', 'production_grade_v101',
...
def main() -> None:
    ...
    report = {
        ...
        'version': 'V102',
        'source': str(SRC_DIR),
        'contract': 'V102 balanced volume gate: preserve V101 A core and promote validated A/B/C robust rows when market_state=MIXED and daily_structure_state=DOWN_STRUCTURE.',
    ...
    payloads = {
        'v102_trades.json': enriched_trades,
        'v102_active_picks.json': active_production_picks,
        'v102_candidate_picks.json': candidate_picks,
        'v102_bos_continuation_candidates.json': bos_continuation_candidates,
        'v102_symbol_dna.json': dna,
        'v102_report.json': report,
