...
OUT_JSON = ROOT / 'smc_audit' / 'v66_signal_sequence_audit.json'
OUT_MD = ROOT / 'smc_audit' / 'v66_signal_sequence_audit.md'
...
def main() -> None:
    ...
    trade_path = V66_TRADES if V66_TRADES.exists() else V49_TRADES
