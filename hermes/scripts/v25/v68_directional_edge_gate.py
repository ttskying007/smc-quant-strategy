#!/usr/bin/env python3
"""Directional edge gate for V68 candidate trades."""
...
OUT = AUDIT / 'v68_directional_edge_gate.json'
...
def main() -> None:
    ...
    for h in HORIZONS:
        ...
        comparisons[str(h)] = {'candidate': cand, 'same_symbol_random': base, 'mean_edge': mean_edge, 'pos_rate_edge': pos_edge, 'pass': horizon_pass}
    out = {
        ...
        'decision': 'PASS' if pass_horizons >= MIN_PASS_HORIZONS else 'BLOCK_DIRECTIONAL_EDGE',
