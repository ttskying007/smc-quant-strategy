#!/usr/bin/env python3
"""V263 no-write: test whether pre-entry 60m confirmation can rescue V262 fresh BOS supply.
...
M60_DIR = BASE / 'kline_cache_60min'
TS = datetime.now().strftime('%Y%m%d_%H%M%S')
OUT = BASE / f'smc_audit/v263_v262_60m_confirmation_probe_no_write_{TS}'
LATEST = BASE / 'smc_audit/v263_v262_60m_confirmation_probe_latest.json'
...
def main() -> None:
    ...
    enriched.to_csv(OUT / 'v263_v262_child_with_m60.csv', index=False)
    ...
    if not fr.empty:
        ...
        fr.to_csv(OUT / 'v263_frontier.csv', index=False)
    summary = {
        'version': 'V263_V262_60M_CONFIRMATION_PROBE_NO_WRITE',
        ...
        'decision': 'NO_PROMOTION__60M_PREENTRY_CONFIRMATION_DOES_NOT_RESCUE_V262_DAILY_SUPPLY',
