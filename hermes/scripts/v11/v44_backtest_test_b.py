...
print(f"Testing V44-B on {len(symbols)} stocks...")

from v44_engine_b import (
...
if all_trades:
    ...
    # 保存结果
    outpath = OUTPUT_DIR / 'v44_test_b.json'
    json.dump({
        ...
        'config': {
            ...
            'bear_enhanced': True,
            'variant': 'B-relaxed-trail-lock',
            'trailing_bull_loose': [(10.0, 6.0), (6.0, 3.0), (3.0, 0.0)],
            'trailing_bull_tight': [(3.0, 0.0)],
            'trailing_bear_loose': [(10.0, 6.0), (6.0, 3.0), (3.0, 0.0)],
            'trailing_bear_tight': [(3.0, 0.0)],
        },
        'summary': {
