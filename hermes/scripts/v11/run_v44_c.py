#!/usr/bin/env python3
"""V44 Variant C — backtest 200 stocks with retest disabled"""
...
print(f"V44 Variant C: {len(symbols)} stocks | retest=OFF | V38.4 trailing")

from v44_engine_c import (
...
if all_trades:
    ...
    print(f"  Retest entries: 0 (disabled)")
    ...
    json.dump({
        ...
        'version': 'V44-C',
        'config': {
            'ob_v14': True, 'retest_entry': False,
            'dynamic_trailing': True, 'quality_grades': True,
            'bear_enhanced': True, 'variant': 'C',
        },
        'summary': {
