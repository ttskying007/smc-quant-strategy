...
TITLES = [
    ...
    # FIX(2026-09-08, P2 事件标注集): 注销/激励类 = 股本管理(非市场回购) → 硬否。
    # 旧断言 True 是语义bug(33.7% EVENT标题属此类); 黄金集核对后修正。
    ("关于回购注销2022年限制性股票激励计划部分限制性股票的公告", False, None, 0),
    ...
    ("回购注销部分限制性股票的公告", False, None, 0),  # P2标注集: 注销类硬否
    ("关于公司股东增持公司股份计划的公告", True, "HOLDER_INCREASE", +1),
    ("关于2025年限制性股票激励计划回购注销的公告", False, None, 0),  # P2标注集: 注销类硬否
