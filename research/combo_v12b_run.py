# -*- coding: utf-8 -*-
"""v12b: SMC leg with RANGE filter (ADX<20) INSTEAD of bearFVG.
RANGE alone was stronger (+3.72%) than bearFVG (+3.02%); more samples."""
...
# SMC: UPTREND/MARKUP + RANGE(ADX<20)
trades = []
...
for t in trades:
    ...
    if adx is not None and adx < 20:
        smc.append(t)
print("SMC (UPTREND/MARKUP + RANGE ADX<20):", len(smc))
