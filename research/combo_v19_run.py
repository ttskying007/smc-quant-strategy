# -*- coding: utf-8 -*-
"""延续腿（MARKUP 结构支撑回撤）加入 v18 组合测试
v18（SMC反转 + 事件反转）+ 延续腿 → 组合是否提升？"""
...
print("延续腿 (MARKUP 结构支撑):", len(cont))
...
for t in cont + trades_v18:
    ...
    seen.add(key)
    combined.append(t)
print(f"合并（去重）: {len(combined)}")
report("v18 + 延续腿（去重）", combined)
