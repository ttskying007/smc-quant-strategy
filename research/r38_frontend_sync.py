...
review = {
    "verdicts": [
        ...
        {"id": "预增扩池", "name": "业绩预增事件(扩池候选)", "result": "✅ 唯一通过全部检验",
         "detail": "IS PF2.58→OOS PF3.56(比1.38)优于事件腿基线3.20; 逐年���正 "
                   "2024+5.39/2025+7.70/2026+3.00; 退市偏差仅6.5%(阈值31.6%); "
                   "增量约157笔/年(事件腿547笔/年的29%)"},
    ...
    "production": [
        ...
        "业绩预增: 唯一通过 IS/OOS+退市偏差双检验的扩池候选 —— 待冻结基线口径重测后接线",
        "下一步: 业绩预增在 gen_v20f 口径下重测(含SL/TP+OOS)+与增持回购合并验证",
    ],
    "iterations": [
