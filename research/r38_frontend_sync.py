...
review = {
    "verdicts": [
        ...
        {"id": "R38-CONVERGE", "name": "R38 迭代收敛(最终)", "result": "仅两处真实改进",
         "detail": "15轮 12+ 假设全部测试完毕。唯一真实改进: ①ACCUM×2 温和加权(PF3.21→3.29) "
                   "②**Wilder 重基线(PF3.08→3.56, MDD -629→-490)**。扩池三连否 + stage/rank/退出 "
                   "全部验证现状 —— 信号层已到边界, 提升空间在**修复基线已知缺陷**而非扩池"},
    ],
    "production": [
        ...
        "使回测与生产口径一致; 前置确认: 生产 paper_sim EVENT 腿是否已在用 core.indicators.adx14_of",
    ...
    "iterations": [
        ...
        {"round": "R38p", "commit": "-", "content": "P1-7 Wilder重基线A/B: PF3.08→3.56/MDD-629→-490, 四项判据全过(晋级)"},
    ],
