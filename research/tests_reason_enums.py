...
ok("reject 六类+STAGE_前缀(R8+BAD_SL_GE_ENTRY, R15+CAPACITY_REJECT)", REJECT_STAGES == {"EVENT_FILTER", "DUP_EXISTING", "DATA_MISSING", "ADX_LT20", "BAD_SL_GE_ENTRY", "CAPACITY_REJECT"})
ok("EXPIRE_REASONS(R8守卫+R18成交前gate+TIMEOUT)", EXPIRE_REASONS == {"BAD_GEOMETRY_FILL_GE_SL", "CAPACITY_REJECT_FILL", "TIMEOUT"})
