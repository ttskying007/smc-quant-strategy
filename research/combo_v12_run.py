# -*- coding: utf-8 -*-
"""v12: SMC leg restricted to RANGE state (ADX<20, reversal-friendly) + events depth-hold.
Historical v255 said skip RANGE (for trend-following); our reversal signal favors it.
Test in full combo."""
...
for t in trades:
    ...
    if has_bear_fvg(bs, i, 12):
        ...
        if adx is not None and adx < 20:
            smc_v12.append(t)
print(f"SMC v11: {len(smc_v11)}, v12 (+RANGE): {len(smc_v12)}")
...
print("\n=== v12（SMC+RANGE）vs v11 ===")
combo_report("v11（SMC+bearFVG）", smc_v11)
combo_report("v12（SMC+bearFVG+RANGE）", smc_v12)
conn.close()
