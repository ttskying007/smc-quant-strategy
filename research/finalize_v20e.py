# -*- coding: utf-8 -*-
"""生成 v20e dashboard（逐年/逐月/逐个股统计）"""
import csv, io, json, sys
from collections import defaultdict
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding="utf-8", errors="replace")

trades = []
with open(r"E:\test\smc_project\research\combo_v20e_trades.csv", encoding="utf-8-sig") as fh:
...
dash = {
    ...
    "note": "v20e: 事件腿 rank_score6特征 + 回踩买点×0.99 + 分层TP/SL + 延续固定10日",
}
