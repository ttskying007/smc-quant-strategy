# -*- coding: utf-8 -*-
"""v17 execution quality audit (per user: every iteration). Check if 15d hold
reduced the 'sell early' problem vs v16b (10d)."""
...
print("\n对比：v16b(10日) 卖早 +4.01%；v17(15日) 应下降")
