...
# collect all MARKUP support with vol20 to compute median
all_rows = []
n = 0
...
print("\n=== v20 + 延续腿(低波动) ===")
report("v20", trades_v20)
seen = set()
combined = []
for t in cont_low + trades_v20:
