# -*- coding: utf-8 -*-
"""v16b: SMC leg = R20 + stage + bearFVG (199 trades, D layer) + v13 events.
Middle ground: keeps FVG quality + more SMC supply than v13."""
...
for t in trades:
    ...
    if has_bear_fvg(bs, i, 12):
        smc.append(t)
print("SMC (R20+stage+FVG):", len(smc))
